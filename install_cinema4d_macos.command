#!/bin/bash
# Cinema 4D MCP Installer for macOS
# Double-click this file to install

set -e

echo "============================================"
echo "Cinema 4D MCP Installer for macOS"
echo "============================================"
echo ""
...
for version in "${C4D_VERSIONS[@]}"; do
    POSSIBLE_PATH="$HOME/Library/Preferences/Maxon/Cinema 4D $version/plugins"
...
if [ -z "$C4D_PLUGINS_DIR" ]; then
    ...
    echo "~/Library/Preferences/Maxon/Cinema 4D <version>/plugins/"
    echo ""
